 ...
 */
let e, t;
const n = new WeakMap, r = new WeakMap, o = new WeakMap, s = new WeakMap, a = new WeakMap;
let i = {
  get(e, t, n) {
...
function f(e, t, {blocked: n, upgrade: r, blocking: o, terminated: s} = {}) {
  const a = indexedDB.open(e, t), i = u(a);
  return r && a.addEventListener("upgradeneeded", (e => {
    r(u(a.result), e.oldVersion, e.newVersion, u(a.transaction), e)
  })), n && a.addEventListener("blocked", (e => n(e.oldVersion, e.newVersion, e))), i.then((e => {
...
function p(e, {blocked: t} = {}) {
  ...
  return t && n.addEventListener("blocked", (e => t(e.oldVersion, e))), u(n).then((() => {
  }))
}

const D = ["get", "getKey", "getAll", "getAllKeys", "count"], v = ["put", "add", "delete", "clear"], b = new Map;

function I(e, t) {
  if (!(e instanceof IDBDatabase) || t in e || "string" != typeof t) return;
  if (b.get(t)) return b.get(t);
  const n = t.replace(/FromIndex$/, ""), r = t !== n, o = v.includes(n);
